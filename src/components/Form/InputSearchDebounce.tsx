...
const InputSearchDebounce = ({
  ...
  return (
    <div className="relative w-full text-slate-500 group">
      <input
        {...rest}
        type="text"
        name="_q"
      ...
      <span
        ...
        className="hidden group-hover:block p-[2px] rounded-full border-[2px] border-[#666] absolute right-10 top-[11px] cursor-pointer"
      >
        <X
          size={12}
          color="#333"

...
import { validatePassword } from "../../contants/validate";
      ...
      <div className="px-6 h-full text-gray-800">
        <div className="flex xl:justify-center lg:justify-between justify-center items-center flex-wrap h-full g-6">
          <div className="grow-0 shrink-1 md:shrink-0 basis-auto xl:w-6/12 lg:w-6/12 md:w-9/12 mb-12 md:mb-0 flex justify-center">
            <img src={dragonball} className="w-[55%]" alt="Sample image" />
          </div>
          <div className="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="text-center lg:text-left">
                <button className="py-3 px-4 w-full xl:w-32 xl:mr-3 align-top bg-lime-500 rounded-2xl hover:bg-lime-600" >Đăng nhập</button>
                <p className="text-sm font-semibold mt-2 pt-1 mb-0">
                  Don't have an account?
                  <a href="#!" className="text-teal-100 hover:text-lime-600 focus:text-lime-600 ml-3 transition duration-200 ease-in-out">Register</a>
                </p>
              </div>
            </form>
            <form />
